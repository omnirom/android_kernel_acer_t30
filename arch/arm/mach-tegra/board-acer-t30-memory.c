...
static const struct tegra_emc_table cardhu_emc_tables_picasso_E2_WIFI_elpida[] =
{
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
	...
	},
	{
		...
		333500,     /* SDRAM frequency */
		{
			...
			0x00008000, /* EMC_CFG_DIG_DLL_PERIOD */
			0x00058000, /* EMC_DLL_XFORM_DQS0 */
			0x00058000, /* EMC_DLL_XFORM_DQS1 */
			0x00058000, /* EMC_DLL_XFORM_DQS2 */
			0x00058000, /* EMC_DLL_XFORM_DQS3 */
			0x00058000, /* EMC_DLL_XFORM_DQS4 */
			0x00058000, /* EMC_DLL_XFORM_DQS5 */
			0x00058000, /* EMC_DLL_XFORM_DQS6 */
			0x00058000, /* EMC_DLL_XFORM_DQS7 */
			0x00000000, /* EMC_DLL_XFORM_QUSE0 */
			0x00000000, /* EMC_DLL_XFORM_QUSE1 */
			0x00000000, /* EMC_DLL_XFORM_QUSE2 */
			0x00000000, /* EMC_DLL_XFORM_QUSE3 */
...
static const struct tegra_emc_table cardhu_emc_tables_picasso_E2_WIFI_hynix_1gb[] =
{
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
	...
	},
	{
		...
		333500,     /* SDRAM frequency */
		{
			...
			0x002600a4, /* EMC_CFG_DIG_DLL */
			0x00008000, /* EMC_CFG_DIG_DLL_PERIOD */
			0x0004c000, /* EMC_DLL_XFORM_DQS0 */
			0x0004c000, /* EMC_DLL_XFORM_DQS1 */
			0x0004c000, /* EMC_DLL_XFORM_DQS2 */
			0x0004c000, /* EMC_DLL_XFORM_DQS3 */
			0x0004c000, /* EMC_DLL_XFORM_DQS4 */
			0x0004c000, /* EMC_DLL_XFORM_DQS5 */
			0x0004c000, /* EMC_DLL_XFORM_DQS6 */
			0x0004c000, /* EMC_DLL_XFORM_DQS7 */
			0x00000000, /* EMC_DLL_XFORM_QUSE0 */
			0x00000000, /* EMC_DLL_XFORM_QUSE1 */
			0x00000000, /* EMC_DLL_XFORM_QUSE2 */
			0x00000000, /* EMC_DLL_XFORM_QUSE3 */
...
static const struct tegra_emc_table cardhu_emc_tables_picasso_E2_3G_Hynix_1gb[] =
{
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
			...
			0x00004288, /* EMC_FBIO_CFG5 */
			0x007800a4, /* EMC_CFG_DIG_DLL */
			0x00008000, /* EMC_CFG_DIG_DLL_PERID */
			0x000fc000, /* EMC_DLL_XFORM_DQS0 */
			0x000fc000, /* EMC_DLL_XFORM_DQS1 */
			0x000fc000, /* EMC_DLL_XFORM_DQS2 */
			0x000fc000, /* EMC_DLL_XFORM_DQS3 */
	...
	case BOARD_PICASSO_E2:
		...
		switch(RAM_CODE){
			...
			case 1:
				switch(acer_sku) {
					case BOARD_SKU_WIFI:
						pr_info("%s: WIFI SKU Hynix memory found\n", __func__);
						tegra_init_emc(cardhu_emc_tables_picasso_E2_WIFI_hynix_1gb,
								ARRAY_SIZE(cardhu_emc_tables_picasso_E2_WIFI_hynix_1gb));
						break;
					case BOARD_SKU_3G:
						pr_info("%s: 3G SKU Hynix 1GB memory found\n", __func__);
						tegra_init_emc(cardhu_emc_tables_picasso_E2_3G_Hynix_1gb,
								ARRAY_SIZE(cardhu_emc_tables_picasso_E2_3G_Hynix_1gb));
						break;
				}
				break;
			case 2:
				switch(acer_sku) {
					case BOARD_SKU_WIFI:
						pr_info("%s: WIFI SKU Elpida memory found\n", __func__);
						tegra_init_emc(cardhu_emc_tables_picasso_E2_WIFI_elpida,
								ARRAY_SIZE(cardhu_emc_tables_picasso_E2_WIFI_elpida));
						break;
					case BOARD_SKU_3G:
